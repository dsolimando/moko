...
export class StackNavigator {
    ...
    insertNavigationBarForPush() {
        ...
        const $navBar = this.activeController.render().insertAdjacentHTML(
            'afterbegin',
            `<moko-navigation-bar anim-back-title="true" title="${title}" back-title="${backTitle}"><moko-back-button/></moko-navigation-bar>`
        )
    ...
    insertNavigationBarForPop() {
        ...
        const $navBar = this.passiveController.render().insertAdjacentHTML(
            'afterbegin',
            `<moko-navigation-bar title="${title}" back-title="${backTitle}"><moko-back-button></moko-back-button></moko-navigation-bar>`
        )
        this.activeController.render().querySelector('moko-navigation-bar').navigator = this
    }
